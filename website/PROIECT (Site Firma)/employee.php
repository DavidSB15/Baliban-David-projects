...
//conn to db
  ...
  $sql = 'SELECT ID, Nume, Prenume, Varsta FROM angajati ORDER BY ID';
...
<div class="square">
  <center>
  <h1 class="center gray-text">Lista angajatilor: </h1><br></center>
    ...
    <td>Varsta</td>
      ...
      <?php foreach($angajati as $angajat) {?>
            ...
            <table id="demotable">
              ...
              <td><?php echo htmlspecialchars($angajat['Nume']); echo str_repeat('&nbsp;', 5);?></td>
              <td><?php echo htmlspecialchars($angajat['Prenume']); echo str_repeat('&nbsp;', 5);?></td>
              <td><?php echo htmlspecialchars($angajat['Varsta']); ?></td></tr></h2>
            </table>
      <?php } ?>
</div>
